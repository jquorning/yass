...
--  end read only
--  begin read only
   procedure Wrap_Test_Show_Message_b0ef3e_268f83 (Text         : String; Message_Type : Messages_Types := Default_Message_Type) 
   is
   begin
      begin
         pragma Assert
      ...
      GNATtest_Generated.GNATtest_Standard.Messages.Show_Message (Text, Message_Type);
   end Wrap_Test_Show_Message_b0ef3e_268f83;
--  end read only

--  begin read only
   procedure Test_Show_Message_test_show_message (Gnattest_T : in out Test);
   procedure Test_Show_Message_b0ef3e_268f83 (Gnattest_T : in out Test) renames Test_Show_Message_test_show_message;
--  id:2.2/b0ef3ea444439e3e/Show_Message/1/0/test_show_message/
   procedure Test_Show_Message_test_show_message (Gnattest_T : in out Test) is
      procedure Show_Message (Text         : String; Message_Type : Messages_Types := Default_Message_Type) renames Wrap_Test_Show_Message_b0ef3e_268f83;
--  end read only
